...
#ifndef __FDAPDE_GRADIENT_DESCENT_H__
#define __FDAPDE_GRADIENT_DESCENT_H__
...
template <int N> class GradientDescent {
   ...
   public:
    ...
    double h;
    // constructor
    GradientDescent() : max_iter_(500), tol_(1e-5), step_(1e-2) { }
    GradientDescent(int max_iter, double tol, double step) : max_iter_(max_iter), tol_(tol), step_(step) { }
    GradientDescent(const GradientDescent& other) : max_iter_(other.max_iter_), tol_(other.tol_), step_(other.step_) { }
...
#endif   // __FDAPDE_GRADIENT_DESCENT_H__
