...
void operation_in_thread(fdapde::Synchro_queue<value,fdapde::relax_nowait> & q, std::vector<int>::iterator begin,std::vector<int>::iterator end, value el, std::atomic<int>& count){
    /*
