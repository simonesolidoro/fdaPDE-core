...
void operation_in_thread(fdapde::Synchro_queue<value,fdapde::hold_wait> & q, std::vector<int>::iterator begin,std::vector<int>::iterator end, value el){
...
int main(int argc, char** argv){
    ...
    fdapde::Synchro_queue<value,fdapde::hold_wait> q(size_coda*2);
