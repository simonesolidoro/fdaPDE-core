...
void operation_in_thread(fdapde::Synchro_queue<value,fdapde::relax_nowait> & q, value el, std::vector<int>::iterator begin,std::vector<int>::iterator end){
...
int main(int argc, char** argv){
    ...
    for (int i=0; i<size_coda;++i) {
        operations.push_back(distrib(gen));
    }
