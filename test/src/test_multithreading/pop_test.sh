...
echo "Worker_queue:  pop di 16000 elemnti con 4 thread:" >> $output_file
...
echo "deque:  pop di 16000 elemnti con 4 thread:" >> $output_file
for i in {1..50}; do
...
# Esegui il secondo file 50 volte
echo "old_worker_queue:  pop di 16000 elemnti con 4 thread:" >> $output_file
for i in {1..50}; do
